...
)  # (corelli/config/settings/base.py - 3 = corelli/)
APPS_DIR = ROOT_DIR.path("corelli")
...
DATABASES = {
    "default": env.db("DATABASE_URL", default="postgres:///corelli")
}
...
LOCAL_APPS = [
    "corelli.users.apps.UsersConfig",
...
MIGRATION_MODULES = {"sites": "corelli.contrib.sites.migrations"}
...
LOGIN_REDIRECT_URL = "home"  # It uses the 'name' attribute, previously its value was "users:redirect"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "corelli.utils.context_processors.settings_context",
            ],
        },
    }
]
